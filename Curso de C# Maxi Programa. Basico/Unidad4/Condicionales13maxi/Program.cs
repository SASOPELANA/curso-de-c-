...
namespace Condicionales13maxi
{
    class Program
    {
        ...
        // (ingresa 1 para extender o un 0 para no extender) y calcule y emita por pantalla el monto de la 
        ...
        Console.WriteLine("¿Amplía disco?");
